...
from src.models import GrowthRate, Pokemon, PokemonSpecies, WinBattle, WinBattleParams
...
def find_level_by_exp(name: str, exp: int) -> int:
...
def win_battle(params: WinBattleParams) -> WinBattle:
    ...
    if (fainted_pokemon and fainted_pokemon.base_experience):
        ...
        cur_exp = cur_exp if cur_exp != None else winner_pokemon.base_experience
